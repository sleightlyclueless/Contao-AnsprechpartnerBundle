 ...
 * Widgets
 */
// Wir haben in der src/ixtensa/AnsprechpartnerBundle/Widget/AbtMenu.php ein zusätzliches Widget (InputType Feld für Contao DCA) abgeleitet von der Contao Checkbox erstellt. Damit wir dieses Feld erstellen und verwenden können müssen wir als aller erstes die Datei "zeigen", damit Sie verwendet und geparst wird. Das machen wir hier über ['BE_FFL']['WidgetName'] = Namespace, wo das Widget konfiguriert wird (Namespace muss dann entsprechend auch in der AbtMenu.php stehen)
/**
...
// Ansprechpartner – Ansprechpartner mit den Abteilungen und vielen weiteren DCA Feldern konfigurieren und für Frontend Ausgabe vorbereiten
...
/*$GLOBALS['BE_FFL']['metaWizard']            = 'MetaWizard';*/
