...
(
	...
	(
		...
		(
			'mode'                    => 2,
            'flag'                    => 1,
            'panelLayout'             => 'filter;abtname_lang, abtname_bez',
			'fields'                  => array('abtname_lang')
		),

        // Elementanzeige im Backend. Zeige für das Element folgende DCA 'fields' in diesem 'format'
		'label' => array
		(
			'fields'                  => array('abtname_lang', 'abtname_bez'),
			'format'                  => '<b>%s</b> - [%s]'
		),
	...
	'palettes' => array
	(
		'default' => '{name_legend},abtname_lang,abtname_bez;'
	),
	...
	(
        ...
        'abtname_bez' => array
        (
            'label'                   => &$GLOBALS['TL_LANG'][$strName]['abtname_bez'],
        	'exclude'                 => true,
            'search'                  => true,
        	'sorting'                 => false,
        	'inputType'               => 'text',
