...
namespace ixtensa\AnsprechpartnerBundle\dca\tl_bemod_abteilungen;
...
(
	...
	(
		...
		(
			'mode'                    => 2,
            'flag'                    => 1,
            'panelLayout'             => 'filter;abtname',
			'fields'                  => array('abtname')
		),
		...
		(
            // Link zurück zur Ansprechpartner Erweiterung – Ansprechpartner verwalten
            'backToAnsprechpartner' => array
			(
				'label'               => &$GLOBALS['TL_LANG'][$strName]['backToAnsprechpartner'],
                'href'                => 'do=ansprechpartner',
				'class'               => 'header_back',
		...
		(
			...
			(
				...
				'href'                => 'table=tl_bemod_abteilungen_lang',
				'icon'                => 'edit.svg'
			),
	...
	(
        ...
        // Der Abteilungsname ist ein Textfeld für die Abteilung, die wir frei erstellen können. Danach werden die child Elemente im nächsten DCA Modul tl_bemod_abteilungen_lang 'übersetzt'
        'abtname' => array
        (
